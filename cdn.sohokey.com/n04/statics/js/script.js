...
$document.ready(function () {
  ...
  if (plugins.search.length || plugins.searchResults) {
    var handler = "/e_products/index.asp";
      ...
      for (i = 0; i < plugins.search.length; i++) {
        var searchItem = $(plugins.search[i]),
          options = {
            ...
            liveCount: (searchItem.attr('data-search-live-count')) ? parseInt(searchItem.attr('data-search-live')) : 400,
        ...
        if (options.live) {
          ...
          searchItem.find('input').on("keyup input propertychange", $.proxy(function () {
            ...
            if (this.term.length > 2000) {
              this.timer = setTimeout(liveSearch(this), 200000000);
